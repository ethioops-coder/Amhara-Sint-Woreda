...
const cabinetMembers = [
  {
    name: 'Ato Abebe Kebede', title: 'Head of Finance & Revenue', icon: Coins, color: '#1a6b3c', photo: '/official_abebe.svg',
  ...
  {
    name: 'W/ro Hiwot Alemu', title: 'Head of Education', icon: GraduationCap, color: '#c8a415', photo: '/official_hiwot.svg',
  ...
  {
    name: 'Ato Dawit Assefa', title: 'Head of Infrastructure', icon: HardHat, color: '#1a6b3c', photo: '/official_dawit.svg',
  ...
  {
    name: 'W/ro Mekdes Tadesse', title: 'Head of Health', icon: Stethoscope, color: '#c8a415', photo: '/official_mekdes.svg',
  ...
  {
    name: 'Ato Tadesse Girma', title: 'Head of Trade & Industry', icon: Briefcase, color: '#1a6b3c', photo: '/official_tadesse.svg',
  ...
  {
    name: 'W/ro Selamawit Bekele', title: 'Head of Social Affairs', icon: HeartHandshake, color: '#c8a415', photo: '/official_selamawit.svg',
  ...
  {
    name: 'Ato Yonas Tesfaye', title: 'City Manager', icon: UserCog, color: '#1a6b3c', photo: '/official_yonas.svg',
  ...
  {
    name: 'W/ro Tigist Mekonnen', title: 'City Council Speaker', icon: Landmark, color: '#c8a415', photo: '/official_tigist.svg',
  ...
  {
    name: 'Ato Fitsum Belete', title: 'Head of Legal Affairs', icon: Scale, color: '#1a6b3c', photo: '/official_fitsum.svg',
  ...
  {
    name: 'W/ro Nardos Tadesse', title: 'Head of Urban Planning', icon: Building2, color: '#c8a415', photo: '/official_nardos.svg',
  ...
  {
    name: 'Ato Henok Mulugeta', title: 'Head of Transport', icon: Bus, color: '#1a6b3c', photo: '/official_henok.svg',
  ...
  {
    name: 'W/ro Bethlehem Hailu', title: 'Head of Water & Energy', icon: Zap, color: '#c8a415', photo: '/official_bethlehem.svg',
